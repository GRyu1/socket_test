...
- 배포: `https://sockettest-production-5035.up.railway.app`
- 진입점: `GET /api/start`
...
```bash
curl https://sockettest-production-5035.up.railway.app/api/start
```
...
```bash
curl -X POST https://sockettest-production-5035.up.railway.app/api/register \
...
```bash
# 1. 구구단 시작
curl -X POST https://sockettest-production-5035.up.railway.app/api/quiz/gugudan/start \
  -H "x-api-key: YOUR_KEY"

# 2. 답변 제출 (반복)
curl -X POST https://sockettest-production-5035.up.railway.app/api/quiz/answer \
  -H "Content-Type: application/json" \
  -H "x-api-key: YOUR_KEY" \
...
```bash
curl https://sockettest-production-5035.up.railway.app/api/history \
  -H "x-api-key: YOUR_KEY"
```
